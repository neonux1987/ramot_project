...
class SetupLogic {
  ...
  async setLocations() {
    ...
    config.db_backup.db_backups_folder_path = SystemPaths.paths.db_backups_folder_path;
    config.db_backup.backups_names_file_path = SystemPaths.paths.backups_names_file_path;
